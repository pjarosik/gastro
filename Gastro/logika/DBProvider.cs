        ...
        static public List<object> getJadlospis(string id_jadlospis)
        {
            var tmp = from jadl in cont.Jadlospis
                      ...
                      select new
                      {
                          ...
                          Nazwa = jadl.nazwa,
                          Ilosc = skl.ilosc,
                          Bialko = (prod.bialko_roslinne + prod.bialko_zwierzece) * skl.ilosc,
                          Wartosc_energetyczna_kCal = prod.Wartosc_energetyczna.kcal* skl.ilosc,
                          Tluszcze = prod.tluszcz * skl.ilosc,
                          Sod = skl_min.sod * skl.ilosc,
                          Potas = skl_min.potas * skl.ilosc,
                          Wapn = skl_min.wapn * skl.ilosc,
                          Fosfor = skl_min.fosfor * skl.ilosc,
                          Magnez = skl_min.magnez * skl.ilosc,
                          Zelazo = skl_min.zelazo * skl.ilosc,
                          Cynk = skl_min.cynk * skl.ilosc,
                          Miedz = skl_min.miedz * skl.ilosc,
                          A = wit.ek_retinolu * skl.ilosc,
                          D = wit.D * skl.ilosc,
                          E = wit.E * skl.ilosc,
                          B1 = wit.tiamina * skl.ilosc,
                          B2 = wit.ryboflawina * skl.ilosc,
                          PP = wit.niacyna * skl.ilosc,
                          B6 = wit.B6 * skl.ilosc,
                          Foliany = wit.foliany * skl.ilosc,
                          B12 = wit.B12 * skl.ilosc,
                          C = wit.C * skl.ilosc
                      };
